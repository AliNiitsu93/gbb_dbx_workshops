...
# MAGIC %md
# MAGIC 
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Short History of Apache Spark
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Who is Databricks?
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) What is Apache Spark?
# MAGIC 
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) A Unifying Engine
# MAGIC 
# MAGIC And as a compute engine, Apache Spark is not tied to a specific environment or data warehouse strategy.
# MAGIC 
# MAGIC ![Unified Engine](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/unified-engine.png)
# MAGIC <br/>
# MAGIC <br/>
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) RDDs
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Scala, Python, Java, R & SQL
...
# MAGIC 
# MAGIC ![RDD vs DataFrames](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/rdd-vs-dataframes.png)

# COMMAND ----------

# MAGIC %md-sandbox
# MAGIC 
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) The Cluster: Drivers, Executors, Slots & Tasks
# MAGIC ![Spark Physical Cluster, slots](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/spark_cluster_slots.png)
...
# MAGIC %md
# MAGIC 
# MAGIC ![Spark Physical Cluster, tasks](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/spark_cluster_tasks.png)
# MAGIC <br/>
# MAGIC <br/>
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Quick Note on Jobs & Stages
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Quick Note on Cluster Management
# MAGIC 
...
# MAGIC %md
# MAGIC ##![Spark Logo Tiny](https://s3-us-west-2.amazonaws.com/curriculum-release/images/105/logo_spark_tiny.png) Architectural & Administrative Topics
# MAGIC 
