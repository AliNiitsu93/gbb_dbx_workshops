...
# MAGIC %md 
# MAGIC ### Write Results to CosmosDB for Online Serving (Website, Ads, Emails)
# MAGIC ![arch](https://kpistoropen.blob.core.windows.net/collateral/roadshow/azure_roadshow_ml.png)

# COMMAND ----------

mongo_output = myRecs.select("product_id", "user_id")

# COMMAND ----------

mongo_output.write.format("com.mongodb.spark.sql.DefaultSource").mode("overwrite").option("uri",
"mongodb://kpistor:EtuJDlScZDt5YMNsB3sU3uR3PY1J5SgAMWxPtiBnr2gOlpKZE40ACwcwC80bSLW2tlNaymCGp8F6ygMHJrZmBQ==@kpistor.documents.azure.com:10255/employees.people?ssl=true").save()
